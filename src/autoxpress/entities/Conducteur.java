...
public class Conducteur extends User{
    ...
    public Conducteur(int cin_conducteur, String nom_conducteur, String prenom_conducteur, int telephone_conducteur, String email_conducteur, String ville_conducteur, String mdp_conducteur, String type_de_permis, String image_conducteur) {
    ...
    public Conducteur(int id_conducteur, int cin_conducteur, String nom_conducteur, String prenom_conducteur, int telephone_conducteur, String email_conducteur, String ville_conducteur, String mdp_conducteur, String type_de_permis,String image_conducteur) {
    ...
    public String toString() {
        return "Conducteur{" + "id_conducteur=" + id_conducteur + ", cin_conducteur=" + cin_conducteur + ", nom_conducteur=" + nom_conducteur + ", prenom_conducteur=" + prenom_conducteur + ", telephone_conducteur=" + telephone_conducteur + ", email_conducteur=" + email_conducteur + ", ville_conducteur=" + ville_conducteur + ", mdp_conducteur=" + mdp_conducteur + ", type_de_permis=" + type_de_permis + ", image_conducteur=" + image_conducteur + '}';
    }
